...
const Draft = ({ history }) => {
    ...
    return(
    <React.Fragment>
        <div className="w-full overflow-y-auto section">
            <div className="w-full flex flex-col">
                <input
                    className="font-noto-bold bg-white bg-opacity-0 text-black text-3xl rounded-t-sm border-b-0 outline-none p-3"
                ...
                <div className="flex items-center">
                    ...
                    <input 
                        className="font-noto-bold bg-white bg-opacity-0 text-black text-md rounded-t-sm border-t-0 outline-none p-3"
            ...
            <div className="w-full flex justify-center mt-5">
                <button 
                    className="p-3 px-10 bg-indigo-300 text-white font-noto-medium text-2xl rounded-sm"
